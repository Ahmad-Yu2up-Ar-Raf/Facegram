...
import { Label } from "@/components/ui/fragments/shadcn/label"
...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-4 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4 [&_input]:text-xs [&_input]:sm:text-sm",
        className
      )}
      {...props}
    />
